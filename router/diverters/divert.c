// See also https://github.com/randonantix/pf-diverters
// See also https://github.com/randonantix/pftabled
...
main(int argc, char *argv[])
{
  ...
  // TODO: I added this. It returns -1. How do we prevent/cleanup "port already in use errors?"
